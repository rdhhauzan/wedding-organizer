            ...
            <div class="detail-block__items">
                <div class="detail-block__item">
                    ...
                    <div class="detail-block__item-info">
                        Perumahan Jkt Forti 8 Blok Z NO 01 Tambun. Jakarta<br>
                    </div>
                </div>
                <div class="detail-block__item">
                    <div class="detail-block__item-icon">
    ...
    <div class="wrapper">
        <div class="contacts-info__content">
            <div class="contacts-info__text">
                <h4>About Me</h4>
                <p>
                    Didirikan sejak 2023 yang menyediakan paket Wedding Organizernya seperti tenda pernikahan, prosesi upacara adat pernikahan, dekorasi bernuasa internasional maupun tradisional, penyediaan foto dan video shooting, undangan dan souvenir, music entertaiment dan sound system.
                </p>
            </div>
